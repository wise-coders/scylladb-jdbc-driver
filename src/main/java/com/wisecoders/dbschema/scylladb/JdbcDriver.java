...
import static com.wisecoders.dbschema.scylladb.ScyllaDBClientURI.PREFIX;
...
public class JdbcDriver implements Driver {
    ...
    public Connection connect(String url, Properties info) throws SQLException {
        if (url != null && acceptsURL(url)) {
            ScyllaDBClientURI clientURI = new ScyllaDBClientURI(url, info);
            try {
                ...
                return new ScyllaDBConnection(session, this, returnNullStringsFromIntroQuery);
