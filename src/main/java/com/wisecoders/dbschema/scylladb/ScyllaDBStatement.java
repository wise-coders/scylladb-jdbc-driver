...
public class ScyllaDBStatement extends ScyllaDBBaseStatement {

    private final ScyllaDBConnection connection;

    ScyllaDBStatement(ScyllaDBConnection connection) {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        checkClosed();
        try {
            result = new ScyllaDBResultSet(this, session.execute(sql));
            return result;
