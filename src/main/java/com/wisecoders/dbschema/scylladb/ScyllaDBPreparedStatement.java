...
public class ScyllaDBPreparedStatement extends ScyllaDBBaseStatement implements java.sql.PreparedStatement {

    private final PreparedStatement preparedStatement;
    private final boolean returnNullStrings;
    private Object[] params;

    ScyllaDBPreparedStatement(CqlSession session, final PreparedStatement preparedStatement, boolean returnNullStrings) {
        super(session);
    ...
    public ResultSet executeQuery() {
        return new ScyllaDBResultSet(this, session.execute(bindParameters()), returnNullStrings);
    }
    ...
    public int executeUpdate() throws SQLException {
        checkClosed();
        try {
            result = new ScyllaDBResultSet(this, session.execute(bindParameters()), returnNullStrings);
            if (result.isQuery()) {
