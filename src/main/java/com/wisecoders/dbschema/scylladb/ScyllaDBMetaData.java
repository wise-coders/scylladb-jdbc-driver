...
import static com.wisecoders.dbschema.scylladb.JdbcDriver.LOGGER;
/**
...
public class ScyllaDBMetaData implements DatabaseMetaData {

    private final ScyllaDBConnection connection;
    private JdbcDriver driver;

    ScyllaDBMetaData(ScyllaDBConnection connection, JdbcDriver driver) {
