...
import com.wisecoders.dbschema.scylladb.types.ArrayResultSet;
import com.wisecoders.dbschema.scylladb.types.BlindPreparedStatement;
...
public class ScyllaDBConnection implements Connection {
    ...
    ScyllaDBConnection(CqlSession session, JdbcDriver jdbcDriver, boolean returnNullStringsFromIntroQuery) {
    ...
    public Statement createStatement() throws SQLException {
        checkClosed();
        try {
            return new ScyllaDBStatement(this);
        } catch (Throwable t) {
            throw new SQLException(t.getMessage(), t);
        }
    }
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        checkClosed();
        try {
            return new ScyllaDBPreparedStatement(session, session.prepare(sql), returnNullStringsFromIntroQuery || !SELECT_COLUMNS_INTRO_QUERY.equals(sql));
    ...
    public DatabaseMetaData getMetaData() throws SQLException {
        checkClosed();
        return new ScyllaDBMetaData(this, driver);
    }
